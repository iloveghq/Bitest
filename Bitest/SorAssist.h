...
public:
	...
	void AddSordataToOtdrTrace(TestResultInfo* pTestResultInfo, COtdrTrace* pOtdrTrace, BOOL bShowOnlyOne=FALSE, COLORREF colorLine=RGB(0, 0, 255) ,WORD* pDataSmooth=NULL);//将sor文件读到的数据转化为otdrtrace变量//wcq2016.01.26
	...
	FLOAT GetUserOffset(SORDATA &sorData);//得到启动光纤长度//wcq2015.12.07
public:
	//CEndGabor m_endgabor;//zll 2013.8.19//后面改为CGaborDllUtil g_gaborDllUtil cwcq2016.04.25
};
